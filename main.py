...
if option == 'y':
    ...
    # Yang Water
        ...
        direct_resource = ['Yang Metal', metal_yang*100]
        indirect_resource = ['Yin Metal', metal_yin*100]
    ...
    print()
    print(f'Direct officer 正官 (Zheng Guang): {direct_officer[0]} {direct_officer[1]}%')
    print(f'Seven killings 七杀 (Qi Sha): {qi_sha[0]} {qi_sha[1]}%')
    print(f'Direct resource 正印 (Zheng Yin): {direct_resource[0]} {direct_resource[1]}%')
    print(f'Indirect resource 偏印 (Pian Yin): {indirect_resource[0]} {indirect_resource[1]}%')
    print(f'Friends 比肩 (Bi Jian): {friends[0]} {friends[1]}%')
    print(f'Rob wealth 劫财 (Jie Cai): {rob_wealth[0]} {rob_wealth[1]}%')
    print(f'Eating god 食神 (Shi Shen): {eating_god[0]} {eating_god[1]}%')
